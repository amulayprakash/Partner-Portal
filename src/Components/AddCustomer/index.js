    ...
    <div>
        <div>
            <form onSubmit={handleSubmit} className='app__form' >
                <h3 className='head-text' >Create A <span>New</span> Customer </h3>
                    
                     <TextField style={{marginTop:'20px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" type='text' label='Enter Name' 
                     onChange={(e) =>setName(e.target.value)} 
                     />
                     <TextField style={{marginTop:'20px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" label='Enter Gender' 
                     type='text' onChange={(e) =>setgender(e.target.value)} 
                     />
                     <TextField style={{marginTop:'20px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" type='text' label='Enter Address' 
                     onChange={(e) =>setAddress(e.target.value)} 
                     />
                     <TextField style={{marginTop:'20px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" label='Enter DOB' 
                     type='date' onChange={(e) =>setdob(e.target.value)} 
                     />
                     <TextField style={{marginTop:'20px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" type='text' label='Enter Blood Group' 
                     onChange={(e) =>setbloodGroup(e.target.value)} 
                     />
                     <TextField style={{marginTop:'20px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" type='text' label='Enter Partner Id' 
                     onChange={(e) =>setpartnerUid(e.target.value)} 
                     />
                     <TextField style={{marginTop:'20px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" type='text' label='Enter User Uid' 
                     onChange={(e) =>setuserUid(e.target.value)} 
                     />
                     <TextField style={{marginTop:'20px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" type='text' label='Enter Child List Uid' 
