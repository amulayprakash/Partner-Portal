...
const ScanDetails = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      setLoading(true);
      axios.get(process.env.REACT_APP_BASE_URL + "/admin/scan").then((res) => {
  ...
  const handleFilterSubmit = async (e) => {
    ...
    axios
      .post(
        process.env.REACT_APP_BASE_URL + "/admin/scan/filter",
      ...
      await axios
        .get(
          process.env.REACT_APP_BASE_URL +
            `/admin/scan/search?searchKey=${lowerCaseValue}`
        )
        .then((res) => {
      ...
      <div className="app__table_scan" style={{ marginTop: "20px" }}>
        <div className="head row">
          ...
          <div className="column_scan" style={{ width: "180px" }}>
            <div className="card_scan">
              <h3 style={{ marginLeft: "1px" }}>IP Address</h3>
            </div>
          </div>
          <div className="column_scan" style={{ width: "180px" }}>
            <div className="card_scan">
                    ...
                    <div className="card_content_scan">
                      <div className="content1">
                        {data?.latitude !== null && data?.longitude !== null ? (
                          <div style={{ display: "flex", alignItems: "left" }}>
                            <p style={{ marginLeft: "5px", displau: "flex" }}>
                              {data?.latitude?.substring(0, 7)}N<span> - </span>
                              {data?.longitude?.substring(0, 7)}E
                            </p>
                          </div>
                        ) : (
                          <div
                      ...
                      <div className="content1">
                        {data?.datetime !== null ? (
                          ...
                          >
                            ...
                            <p style={{ marginLeft: "5px", display: "flex" }}>
