            ...
            }
            {
                customerModal && (
                        ...
                        <MdClose onClick={toggleCustomerModal} style={{color:'#313bac',height:'1.2rem',width:'1.3rem',marginLeft:'300px',marginTop:'10px',marginBottom:'5px'}}  />
                             <h3 className='head-text' style={{fontSize:'1.3rem',marginLeft:'10px'}} >Create A <span>New</span> Customer </h3>
                     ...
                     />
                     <input  style={{marginTop:'10px'}}  className='form__text' id="outlined-basic" 
                     variant="outlined" type='date' placeholder='Enter DOB' 
                    ...
                    <input type='file' onChange={(e) => {
                        ...
                        }  className='form__text' style={{width:'300px',marginLeft:'20%'}} />
                    <Button className='btn p-text close-modal' variant="outlined" 
                    style={{width:'150px',marginTop:'20px',marginLeft:'30%',backgroundColor:'#313bac',color:'white'}}  type='submit'>
                        Submit   
                    </Button>
                    </form>
                    </div>
